...
t_config* iniciar_config(void){
	t_config* nuevo_config = config_create("/home/utnso/Desktop/tp-2026-1c-Grupo3113/cpu/cpu_1.config");
...
{
	t_log* nuevo_logger = log_create("cpu_1.log","CPU 1 LOGGER",1,LOG_LEVEL_INFO);
