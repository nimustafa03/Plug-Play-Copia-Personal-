...
t_config* iniciar_config(void){
	t_config* nuevo_config = config_create("/home/utnso/Desktop/tp-2026-1c-Grupo3113/cpu/cpu_3.config");
...
{
	t_log* nuevo_logger = log_create("cpu_3.log","CPU 3 LOGGER",1,LOG_LEVEL_INFO);
